"""
Ledger Router — Governance-aware output routing

The Ledger Router inspects agent outputs and produces routing decisions
...
class RoutingDecision:
    """
    A routing decision produced by the Ledger Router.
