...
- How Ledger maps to EU AI Act, SOC 2, HIPAA, and NIST AI RMF
...
Ledger's governance architecture is designed to satisfy multiple regulatory frameworks simultaneously:

| Framework | Ledger Feature | Control / Article |
|-----------|---------------|-------------------|
...
1. ✅ Automatic logging (Article 12) — Ledger's hash-chained audit trail
...
> 💡 **The Ledger advantage:** 78% of enterprises are unprepared for the August 2026 deadline. Ledger's kernel-level governance is the only architecture that satisfies both Articles 12 and 14 simultaneously.
...
| Criteria | Ledger Control | Evidence |
|----------|---------------|----------|
...
```python
package = ledger.compliance.export_soc2(
    period="2026-Q1",
...
Ledger's HIPAA-eligible services:
...
```python
posture = ledger.compliance.get_posture()
