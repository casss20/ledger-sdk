  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2 mb-2">
        ...
        >
          <Icon className="w-4 h-4" style={{ color: data.color } as any} />
        </div>
      ...
      <Handle type="target" position={Position.Left} className="w-3 h-3 !bg-slate-600 !border-2 !border-slate-800" />
      <Handle type="source" position={Position.Right} className="w-3 h-3 !bg-slate-600 !border-2 !border-slate-800" />
    </div>
  );
}
